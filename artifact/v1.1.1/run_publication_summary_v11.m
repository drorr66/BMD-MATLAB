function [summary,familySummary]=run_publication_summary_v11(results,varargin)
%RUN_PUBLICATION_SUMMARY_V11 Aggregate frozen publication-validation results.
...
S=struct();
S.validation_version='v1.1-publication-20260820'; S.predictor_frozen='v0.9-static-20260820';
...
if p.Results.SaveResults
    ...
    writetable(summary,fullfile(outDir,'publication_validation_summary_v11.csv'));
    writetable(familySummary,fullfile(outDir,'publication_family_summary_v11.csv'));
end
end
